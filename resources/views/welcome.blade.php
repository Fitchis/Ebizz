        ...
        <section class="bg-blue-900 text-white py-16" >
            <div class="container mx-auto text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    <a href="{{ route('event.details', ['id' => 1]) }}" class="bg-white text-black rounded-lg p-4 flex flex-col transition-transform transform hover:scale-105" data-aos="fade-up">
                    ...
                    <a href="{{ route('event.details', ['id' => 2]) }}" class="bg-white text-black rounded-lg p-4 flex flex-col transition-transform transform hover:scale-105" data-aos="fade-up">
                    ...
                    <a href="{{ route('event.details', ['id' => 3]) }}" class="bg-white text-black rounded-lg p-4 flex flex-col transition-transform transform hover:scale-105" data-aos="fade-up">
                    ...
                    <a href="{{ route('event.details', ['id' => 4]) }}" class="bg-white text-black rounded-lg p-4 flex flex-col transition-transform transform hover:scale-105" data-aos="fade-up">
                    ...
                    <a href="{{ route('event.details', ['id' => 5]) }}" class="bg-white text-black rounded-lg p-4 flex flex-col transition-transform transform hover:scale-105" data-aos="fade-up">
                ...
                <a class="btn bg-blue-600 text-white mt-10 py-2 px-4 hover:bg-blue-800 hover:text-white transition-colors duration-300 rounded-full" data-aos="fade-up" href="{{ route('events.index') }}">
                    Selengkapnya
                </a>
            </div>
            {{-- coursel --}}
            <div class="carousel-container my-5 p-3 rounded mx-auto" data-aos="fade-up">
